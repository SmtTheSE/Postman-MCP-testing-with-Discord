...
async function setupServerHandlers(server, tools) {
  ...
  server.setRequestHandler(CallToolRequestSchema, async (request) => {
    ...
    try {
      if (args.__auth_token) process.env.__MCP_AUTH_TOKEN = args.__auth_token;
      if (args.__auth_user) process.env.__MCP_AUTH_USER = typeof args.__auth_user === 'string' ? args.__auth_user : JSON.stringify(args.__auth_user);
      ...
      delete process.env.__MCP_AUTH_USER;
    }
  });
}
