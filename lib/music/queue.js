...
export function serializeSession(guildId, channelId, connected = false, extra = {}) {
  ...
  const baseState = {
    ...
    settings: {
        ...
        announceChannelId: storeState.announceChannelId,
        mood: storeState.mood || 'normal',
        karaokeEnabled: Boolean(storeState.karaokeEnabled),
        djRouletteEnabled: Boolean(storeState.djRouletteEnabled),
    },
    playbackError,
    playbackErrorCode,
    ...extra
