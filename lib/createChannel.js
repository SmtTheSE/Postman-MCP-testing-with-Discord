import { clampVoiceBitrate } from './voiceBitrate.js'
import { runWithBotToken } from './mcpRunner.js'
import { resolveChannelName } from './channelName.js'
import { assertUserGuildAccess, PERMISSION } from './guildAuth.js'
...
export async function createVoiceChannelViaMcp({
  ...
  await assertUserGuildAccess(accessToken, guildId, PERMISSION.MANAGE_CHANNELS, 'Manage Channels', userId)

  return runWithBotToken(async () => {
