...
app.post('/api/music/vote-skip', (req, res) => musicApi.voteSkip(req, res))
...
app.post('/api/music/mood', (req, res) => musicApi.mood(req, res))
...
app.post('/api/music/mood-playlists', (req, res) => musicApi.moodPlaylistSave(req, res))
app.delete('/api/music/mood-playlists', (req, res) => musicApi.moodPlaylistDelete(req, res))
